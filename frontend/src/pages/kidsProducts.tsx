...
export default function KidsProducts() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    let result = apiProducts.filter((p: any) => p.gender === 'kids');
  ...
  return (
    <Layout>
      {/* Hero Banner (Kept your custom Yellow/Green gradient) */}
      <div className="bg-gradient-to-r from-yellow-500/20 to-green-500/20 py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-display text-4xl md:text-6xl font-bold text-foreground mb-4">
            Kids' Collection
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Durable and fun footwear for active kids. Built to last through every adventure.
          </p>
        </div>
      </div>
            ...
            <>
                ...
                {filteredProducts.length === 0 && (
                  <div className="text-center py-16">
                    <p className="text-muted-foreground">No kids products found in this category.</p>
